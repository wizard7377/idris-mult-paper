...
Among the more important operations on \omegasym
...
While we can create equivalents of $\code{combine}$ and $\code{join}$, we \emph{cannot} create the equivalents of $\code{split}$ and can only create a specific version $\code{expand}$.
