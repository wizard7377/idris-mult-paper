...
In particular, the work of languages like \granule to create a generalized notion of this in a way that can easily be inferred and checked is important.
However, in terms of QTT (or even systems outside it) this is far from complete.
...
With particular use seen in compilers, bump arena allocation, where memory is pre-allocated per phase, helps both separate and simplify memory usage.
